...
class GPT(nn.Module):
    ...
    def from_pretrained(cls, model_type, override_args=None):
        ...
        if 'dropout' in override_args:
            ...
            config_args['activation'] = override_args['activation']
    ...
    def configure_optimizers(self, weight_decay, learning_rate, betas, device_type, type="ADAM"):
        ...
        if type=="fused_ADAM":
            ...
            print(f"using original ADAM optimizer")
        else:
